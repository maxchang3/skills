...
Write and run AI Extension evals with tool mocks, expectations, and suggested prompts.
...
Define evals in the `ai.evals` array in your [extension manifest](/information/manifest.md#ai-properties), or under `evals` in an [`ai.yaml` file](/ai/learn-core-concepts-of-ai-extensions.md#ai-file).
...
![Copy Eval](https://2922539984-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F-Me_8A39tFhZg3UaVoSN%2Fuploads%2Fgit-blob-93e209abebda96e921665f0b5be59bc6bdebe7be%2Fcopy-eval.webp?alt=media)
