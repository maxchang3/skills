...
| entryPointMode<mark style="color:red;">\*</mark>    | The mode of the launched entry point, as specified in package.json                                                                | `"view"` or `"no-view"` or `"menu-bar"` |
| entryPointName<mark style="color:red;">\*</mark>    | The name of the launched entry point, as specified in package.json                                                                | `string`                                |
| entryPointType<mark style="color:red;">\*</mark>    | The type of the launched entry point                                                                                              | `"command"` or `"tool"`                 |
