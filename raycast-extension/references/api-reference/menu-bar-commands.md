> For the complete documentation index, see [llms.txt](https://developers.raycast.com/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://developers.raycast.com/api-reference/menu-bar-commands.md).
...
* make generous use of the [Cache API](/api-reference/cache.md) and our [Utilities](/utilities/getting-started.md) in order to provide quick feedback and ensure action handlers work as expected
...
```
GET https://developers.raycast.com/api-reference/menu-bar-commands.md?ask=<question>
```
