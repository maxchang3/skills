> For the complete documentation index, see [llms.txt](https://developers.raycast.com/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://developers.raycast.com/basics/debug-an-extension.md).
...
![Unhandled exception in development mode](/files/VTF8DErXvSU7GecT7zD4)
...
![Extension Issues](/files/XAvpR83ansTwHf6REDIf)
...
![React Developer Tools](/files/SBBXJM1Po2D78qbl42yT)
...
```
GET https://developers.raycast.com/basics/debug-an-extension.md?ask=<question>
```
