> For the complete documentation index, see [llms.txt](https://developers.raycast.com/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://developers.raycast.com/basics/publish-an-extension.md).

# Publish an Extension

Before you publish your extension, take a look at [how to prepare your extension](/basics/prepare-an-extension-for-store.md) for the Store. Making sure you follow the guidelines is the best way to help your extension pass the review.
...
![Manage your extensions](/files/GIVc69jIF142uhyoQeEB)
...
```
GET https://developers.raycast.com/basics/publish-an-extension.md?ask=<question>
```
