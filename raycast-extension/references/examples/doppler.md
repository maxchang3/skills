> For the complete documentation index, see [llms.txt](https://developers.raycast.com/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://developers.raycast.com/examples/doppler.md).
...
![Example: Safely share secrets with Doppler](/files/bqURwpu5VThrgZ2yaTZt)
...
```
GET https://developers.raycast.com/examples/doppler.md?ask=<question>
```
