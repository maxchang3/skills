> For the complete documentation index, see [llms.txt](https://developers.raycast.com/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://developers.raycast.com/information/manifest.md).
...
| commands<mark style="color:red;">\*</mark>    | An array of [commands](/information/terminology.md#command) exposed by the extension, see [Command properties](#command-properties).                                                                                                     |
...
All properties for a [command](/information/terminology.md#command).
...
All properties for command arguments. Use the [Arguments API](/information/lifecycle/arguments.md) to access their values.

| Property                                      | Description                                                                                                                                                                                                                                      |
| --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| name<mark style="color:red;">\*</mark>        | A unique id for the argument. This value will be used to as the key in the object passed as [top-level prop](/information/lifecycle/arguments.md#arguments).                                                                                     |
...
```
GET https://developers.raycast.com/information/manifest.md?ask=<question>
```
