...
* **AI**: Added [`AI.experimental_decide`](https://developers.raycast.com/misc/pages/RntXmm9tJ3rw5ho48kFJ#ai.experimental_decide) to answer multiple typed questions about shared input in one request. Get yes/no probabilities, choose between named options, or score against ordered criteria. This API is experimental and may change in future releases.
