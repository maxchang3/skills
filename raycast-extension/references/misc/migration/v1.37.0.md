> For the complete documentation index, see [llms.txt](https://developers.raycast.com/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://developers.raycast.com/misc/migration/v1.37.0.md).
...
```
GET https://developers.raycast.com/misc/migration/v1.37.0.md?ask=<question>
```
