> For the complete documentation index, see [llms.txt](https://developers.raycast.com/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://developers.raycast.com/teams/getting-started.md).
...
![Create an Organization](/files/RnwiEE7wp8ng0XCLkZBu)
...
![Create Local Repository](/files/yx77mlkUuheKkeClM3Jv)
...
![Build the Getting Started Extension](/files/VFqHhVptBOW1kY5dxaB4)
...
![Publish the Getting Started Extension](/files/utF1t8SolDKGisY0iS97)
...
```
GET https://developers.raycast.com/teams/getting-started.md?ask=<question>
```
