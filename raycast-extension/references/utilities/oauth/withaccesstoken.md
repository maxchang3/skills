...
{% hint style="info" %}
The access token isn't injected into the wrapped component or function's props. Read it synchronously with [getAccessToken](/utilities/oauth/getaccesstoken.md), including from helpers and callbacks used by the authenticated command.
{% endhint %}
