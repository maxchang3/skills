> For the complete documentation index, see [llms.txt](https://developers.raycast.com/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://developers.raycast.com/utilities/react-hooks/usefetch.md).
...
```
GET https://developers.raycast.com/utilities/react-hooks/usefetch.md?ask=<question>
```
